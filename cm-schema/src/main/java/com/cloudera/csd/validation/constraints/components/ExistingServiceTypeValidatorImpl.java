...
/**
 * Implementation of ExistingServiceType constraint based on a static list of
 * service types.
 */
public class ExistingServiceTypeValidatorImpl
  implements ExistingServiceTypeValidator {

  private final Set<String> builtInServiceTypes;

  public ExistingServiceTypeValidatorImpl(Set<String> builtInServiceTypes) {
    this.builtInServiceTypes = builtInServiceTypes;
  }

  @Override
  public void initialize(ExistingServiceType constraintAnnotation) {}
