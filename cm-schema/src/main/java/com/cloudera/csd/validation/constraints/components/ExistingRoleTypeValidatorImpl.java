...
/**
 * Implementation of ExistingRoleType constraint based on a static list of role
 * types.
 */
public class ExistingRoleTypeValidatorImpl
  implements ExistingRoleTypeValidator {

  private final Set<String> builtInRoleTypes;

  public ExistingRoleTypeValidatorImpl(Set<String> builtInRoleTypes) {
    this.builtInRoleTypes = builtInRoleTypes;
  }

  @Override
  public void initialize(ExistingRoleType constraintAnnotation) {}
