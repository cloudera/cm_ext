 ...
 * monitoring violation to look and feel like violation produced by the
 * hibernate validator.
 *
 * @param <T> The root object type.
 */
public class MonitoringConstraintViolation<T> implements ConstraintViolation<T>,
    Serializable {
  ...
  public boolean equals(Object o) {
    if (!(o instanceof MonitoringConstraintViolation<?>)) {
      return false;
    }
    MonitoringConstraintViolation<?> that = (MonitoringConstraintViolation<?>) o;
