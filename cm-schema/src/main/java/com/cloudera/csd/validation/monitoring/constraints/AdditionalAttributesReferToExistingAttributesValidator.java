 ...
 */
public class AdditionalAttributesReferToExistingAttributesValidator
    extends AbstractMonitoringValidator<RoleMonitoringDefinitionsDescriptor> {

  private final ImmutableSet<String> builtInAttributes;

  public AdditionalAttributesReferToExistingAttributesValidator(
  ...
  public String getDescription() {
    return
        "Validates that additional immutable and mutable attribute names " +
        "refer to either attributes defined in this descriptor or built-in " +
        "attribute names.";
  }
  ...
  public <T> List<ConstraintViolation<T>> validate(
      ...
      RoleMonitoringDefinitionsDescriptor entity,
    ...
    ret.addAll(this.<T>checkAttributes(context,
                                       entity.getAdditionalImmutableAttributeNames(),
                                       "additionalImmutableAttributeNames",
                                       entity,
                                       path));
    ret.addAll(this.<T>checkAttributes(context,
                                       entity.getAdditionalMutableAttributeNames(),
      ...
      if (!context.attributesDefined.containsKey(attribute) &&
        ...
        String msg = String.format(
            "Unknown attribute '%s' for metric entity type '%s'.",
             ...
             entity.getName());
        ret.addAll(
            AbstractMonitoringValidator.<T, RoleMonitoringDefinitionsDescriptor>
