 ...
 * non-worker role type.
 */
public interface RollingRestartNonWorkerStepDescriptor {
  ...
  /**
   * List of role-level commands to run while bringing the role down during rolling
  ...
  /**
   * List of role-level commands to run while bringing the role up during rolling restart.
