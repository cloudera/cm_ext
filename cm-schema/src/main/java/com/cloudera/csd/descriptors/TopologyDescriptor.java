...
public interface TopologyDescriptor {
  ...
  /**
   * Optional. This should be set to true in cases where only an odd number
   * of instances should be running, for the role type containing this descriptor.
   * This might be important for some HA architectures.
